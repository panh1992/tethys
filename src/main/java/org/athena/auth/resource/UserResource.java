...
import org.athena.auth.params.UserInfoParams;
...
public class UserResource {
    ...
    @PUT
    public Response update(@ApiParam(value = "参数", required = true) @Valid UserInfoParams params) {
        userBusiness.update(SystemContext.getUserId(), params.getNickName(), params.getEmail(),
