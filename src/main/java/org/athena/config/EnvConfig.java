...
public final class EnvConfig {
    ...
    public static void registerResource(AthenaConfiguration configuration, Environment environment) {
        ...
        final RoleRepository roleRepository = jdbi.onDemand(RoleRepository.class);
        final ResourceRepository resourceRepository = jdbi.onDemand(ResourceRepository.class);
        ...
        final UserBusiness userBusiness = new UserBusiness(idWorker, userRepository, roleRepository,
                resourceRepository);
     ...
     * 注册过滤器
     */
    private static void registerFilter(Environment environment) {
