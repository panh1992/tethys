...
public class ServiceLocatorDecorator implements ServiceLocator {
    ...
    @Override
    public <T> T getService(Class<T> clazz, Annotation... annotations) throws MultiException {
        return delegate.getService(clazz, annotations);
    }
    ...
    @Override
    public <T> T getService(Class<T> clazz, String s, Annotation... annotations) throws MultiException {
        return delegate.getService(clazz, s, annotations);
    }
    ...
    @Override
    public <T> List<T> getAllServices(Class<T> clazz, Annotation... annotations) throws MultiException {
        return delegate.getAllServices(clazz, annotations);
    }
    ...
    @Override
    public <T> ServiceHandle<T> getServiceHandle(Class<T> clazz, Annotation... annotations) throws MultiException {
        return delegate.getServiceHandle(clazz, annotations);
    }
    ...
    @Override
    public <T> ServiceHandle<T> getServiceHandle(Class<T> clazz, String s, Annotation... annotations) throws MultiException {
        return delegate.getServiceHandle(clazz, s, annotations);
    }
    ...
    @Override
    public <T> List<ServiceHandle<T>> getAllServiceHandles(Class<T> clazz, Annotation... annotations) throws MultiException {
        return delegate.getAllServiceHandles(clazz, annotations);
    }
    ...
    @Override
    public <T> T create(Class<T> clazz, String s) {
        return delegate.create(clazz, s);
    }
    ...
    public <U> U createAndInitialize(Class<U> clazz) {
        return delegate.createAndInitialize(clazz);
    }

    @Override
    public <U> U createAndInitialize(Class<U> clazz, String s) {
        return delegate.createAndInitialize(clazz, s);
    }
