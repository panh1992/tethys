package org.athena.common.path;
...
public class AntPathMatcher implements PathMatcher {
    ...
    /**
     * 使用自定义路径分割符构造AntPathMatcher
     */
    public AntPathMatcher(String pathSeparator) {
        Preconditions.checkNotNull(pathSeparator, "'pathSeparator' is required");
    ...
    protected String[] tokenizePattern(String pattern) {
        ...
        if (this.cachePatterns == null || this.cachePatterns) {
    ...
    protected AntPathStringMatcher getStringMatcher(String pattern) {
        ...
        if (matcher == null) {
            ...
            if (this.cachePatterns == null && this.stringMatcherCache.size() >= CACHE_TURNOFF_THRESHOLD) {
                deactivatePatternCache();
                return matcher;
            }
            if (this.cachePatterns == null || this.cachePatterns) {
